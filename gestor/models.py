...
class Consulta(models.Model):
    ...
    peso =models.DecimalField('Peso', max_digits=10, decimal_places=2, blank=False, null=False)
    altura = models.DecimalField('Altura', max_digits=10, decimal_places=2, blank=False, null=False)
    temperatura = models.DecimalField('Temperatura', max_digits=10, decimal_places=2, blank=False, null=False)
    presionarterial = models.CharField('Presion arterial',max_length=7)
